require('nightfox').setup({
    ...
    groups = {
        all = {
            ...
            DiagnosticVirtualTextError = { style = 'italic,bold' },
            DiagnosticVirtualTextWarn = { style = 'italic,bold' },
            DiagnosticVirtualTextHint = { style = 'italic,bold' },
            DiagnosticVirtualTextInfo = { style = 'italic,bold' },
        },
        terafox = {
